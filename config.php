...
define("SEARCH_PAGE_SONG_LIMIT", 30);
define("ADMIN_SONG_LIMIT", 60);
define("RELATED_FILES_LIMIT", 10);
define("FILE_UPLOAD_SIZE", 268435456); // in bytes
define("IMAGE_UPLOAD_SIZE", 819200); // in bytes
define("ALBUM_SHOW_LIMIT", 45); // number of albums that will show in albums page
define("SINGER_SHOW_LIMIT", 35); // number of singers that will show in singer-list page
